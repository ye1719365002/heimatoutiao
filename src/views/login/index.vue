<template>
  ...
  <!-- 放置表单 绑定数据对象 el-form-model-->
    <el-form ref="myForm" :model="loginForm" :rules="loginRules" >
      <!-- 表单域 里面 porp要写要检验的字段名 放置 input/select/checkbox 相当于一行 -->
    ...
    return {
      ...
      loginRules: {
        ...
        // callback 是一个回调函数
          ...
          // 认为没有勾选
            callback(new Error('您应该同意我们的霸王条款'))// 如果没有勾选认为当前校验失败 应该停止
          }
        } }]
        // agree: [{ validator }]
      }
